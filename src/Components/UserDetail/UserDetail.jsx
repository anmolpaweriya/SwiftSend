...
import UserConnectBar from './UserConnectBar';
...
export default function UserDetail() {
        ...
        <div className='UserDetailDiv'>
            ...
            <svg viewBox="0 0 900 900">
                ...
                <g transform="translate(440.58175959586276 511.58956185041154)">
                    <path fill="#5bb6ff">
                        <animate attributeName="d" values="M188.8 -191C261.6 -116 349.3 -58 346.8 -2.5C344.4 53 251.7 106.1 178.9 147.7C106.1 189.4 53 219.7 -14.8 234.6C-82.7 249.4 -165.5 248.8 -227.8 207.1C-290.1 165.5 -332.1 82.7 -327.7 4.4C-323.3 -74 -272.7 -148 -210.4 -223C-148 -298 -74 -374 -8 -366C58 -358 116 -266 188.8 -191;
    ...
    M188.8 -191C261.6 -116 349.3 -58 346.8 -2.5C344.4 53 251.7 106.1 178.9 147.7C106.1 189.4 53 219.7 -14.8 234.6C-82.7 249.4 -165.5 248.8 -227.8 207.1C-290.1 165.5 -332.1 82.7 -327.7 4.4C-323.3 -74 -272.7 -148 -210.4 -223C-148 -298 -74 -374 -8 -366C58 -358 116 -266 188.8 -191" dur="4s" repeatCount="indefinite"></animate>
                    </path>
                </g>
            </svg>
